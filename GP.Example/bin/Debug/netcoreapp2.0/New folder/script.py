...
predicted = from_json('predicted_test.json', predicted_dt)
observed = from_json('observed_test.json', observed_dt)
aquistition = from_json('aquisition_test.json', observed_dt)
